...
Router.route('deviceListsShow', {
  path: '/devices/:_id/list/:list_id',
  onBeforeAction: function () {
  ...
  data: function () {
    ...
    var device = _.find(list.linkedItems, function (linkedItem) {
      return linkedItem.type === 'device' && linkedItem.id === deviceId;
    });
    return {
      list: list,
      device: device
